(function() {
  ...
  const soloMessages = [
    'คุณกำลังฟังเพลงอย่างอบอุ่นเพียงลำพัง ☕',
    'กำลังดื่มด่ำกับเสียงเพลงคนเดียวเงียบ ๆ 🌙',
    'ฟังเพลงเคล้าความเงียบเหงาคนเดียวอย่างสงบ ✨'
  ];

  const groupMessages = [
    'มีเพื่อนร่วมทาง {count} คนกำลังฟังเพลงด้วยกันตอนนี้ 🌙',
    '{count} คนกำลังแชร์ความรู้สึกผ่านเสียงเพลงนี้อยู่ 💕',
    '{count} คนกำลังดื่มด่ำกับบรรยากาศสุดฟินนี้ไปด้วยกัน 🎵',
    'มีเพื่อนเหงา {count} คนกำลังเปิดฟังอยู่ด้วยกันในตอนนี้ ☕'
  ];
